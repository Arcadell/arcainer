...
/// </summary>
public static class IdentityApiEndpointRouteBuilderExtensionsCustom
{
    ...
    public static IEndpointConventionBuilder MapIdentityApiCustom<TUser>(this IEndpointRouteBuilder endpoints, IdentityApiEndpointRouteBuilderOptions configurationOptions)
        where TUser : class, new()
    {
        ...
        if (!configurationOptions.ExcludeLoginPost)
        {
        ...
        if (!configurationOptions.ExcludeRefreshPost)
        {
        ...
        if (!configurationOptions.ExcludeConfirmEmailGet)
        {
        ...
        if (!configurationOptions.ExcludeResendConfirmationPost)
        {
        ...
        if (!configurationOptions.ExcludeForgotPasswordPost)
        {
        ...
        if (!configurationOptions.ExcludeResetPasswordPost)
        {
        ...
        if (!configurationOptions.Exclude2faPost)
        {
        ...
        if (!configurationOptions.ExcludeInfoGet)
        {
        ...
        if (!configurationOptions.ExcludeInfoPost)
        {
